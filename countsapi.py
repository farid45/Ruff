    ...
    if team != "":
        ...
        if ed_count > 1:
            for data in results:
                ...
                sglistdf = DataFrame(sglistresults["elist"])
                ...
                datadf = concat([nonlawnsdf, lawnsdf])
                ...
                sizedf = DataFrame(datadf.groupby(["CODE"]).size())
                ...
                broaddf = DataFrame(broadresponse["data"])
                if broaddf.empty:
